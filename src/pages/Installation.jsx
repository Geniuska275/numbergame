...
function Installation() {
    ...
    const [installations,setInstallations]=useState([
      ...
      capacity:"180W(5) Panels , 220Ah(1) Battery. "

       },
       { id:4,
        images:[maink1a,maink1b],
        desc: "1kva/12V Inverter Solar system",
         capacity:"180W(4) Panels, 220Ah(1) Battery. ",
      ...
      { id:5,
        ...
        powers: "",
         capacity:"180W(8) Panels ,220Ah(2) Batteries. "
      },
      { id:6,
      ...
      { id:9,
        ...
        desc: "5kva/48V Inverter Solar system",
         capacity:"250W(12) Panels, 220Ah(4) Batteries. ",
      ...
      { id:7,
        ...
        desc: "10kva/48V Inverter Solar system",
         capacity:"250W(24) Panels, 220Ah(8) Batteries. ",
        powers: ""
      },
      { id:1,
