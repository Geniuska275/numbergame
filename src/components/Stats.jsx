...
function Stats() {
  return (
    <div className='Stats bg-[#EDF2EA]'>
        <div className='bg-white m-4 h-[300px] w-[300px] rounded-lg mt-5  flex flex-col p-10 mb-[100px] items-center shadow-lg'>
      <div className='flex gap-2 font-[lato] mb-4 '>
